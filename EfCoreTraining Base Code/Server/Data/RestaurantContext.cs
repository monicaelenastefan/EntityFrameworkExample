...
namespace Server.Data
{
    public static class RestaurantContext
    {
        ...
        public static IList<RestaurantBranch> RestaurantBranches { get; set; }
        public static IList<EmployeeRequirements> EmployeesRequirements { get; set; }
        public static IList<OrderTable> ReservationsTables { get; set; }
        ...
        private static void InitializeData()
        {
            ...
            EmployeesRequirements = new List<EmployeeRequirements>
            {
            ...
            ReservationsTables = new List<OrderTable>
            {
                new OrderTable
                {
                    Id = 1,
